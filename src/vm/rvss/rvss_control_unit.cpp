...
void RVSSControlUnit::SetControlSignals(uint32_t instruction) {
  ...
  switch (opcode) {
    ...
    case 0b1000011: // FMADD (R4-Type)
    case 0b1000111: // FMSUB (R4-Type)
    case 0b1001011: // FNMADD (R4-Type)
    case 0b1001111: { // FNMSUB (R4-Type)
      reg_write_ = true;
      alu_op_ = true;
      break;
    }
...
alu::AluOp RVSSControlUnit::GetAluSignal(uint32_t instruction, bool ALUOp) {
    ...
    case 0b0110011: {// R-Type
        ...
        case 0b000:{ // kAdd, kSub, kMul
            ...
            case 0b0001111: {// kAdd_simd32
                return alu::AluOp::kAdd_simd32;
                break;

            }
            case 0b0011111:{
                return alu::AluOp::kAdd_simd16;
                break;
            }
            case 0b0111111:{
                return alu::AluOp::kAdd_simd8;
                break;
            }
            case 0b1111111:{
        ...
        case 0b001: {// kSll, kMulh
            ...
            case 0b0011111: {
                return alu::AluOp::kSub_simd16;
                break;
            }
            case 0b0111111: {
                return alu::AluOp::kSub_simd8;
                break;
            }
            case 0b1111111:{
        ...
        case 0b010: {// kSlt, kMulhsu
            ...
            case 0b0011111: {
                return alu::AluOp::kMul_simd16;
                break;
            }
            case 0b0111111: {
                return alu::AluOp::kMul_simd8;
                break;
            }
            case 0b1111111:{
        ...
        case 0b011: {// kSltu, kMulhu
            ...
            case 0b0011111: {
                return alu::AluOp::kLoad_simd16;
                break;
            }
            case 0b0111111: {
                return alu::AluOp::kLoad_simd8;
                break;
            }
            case 0b1111111:{
                return alu::AluOp::kLoad_simd4;
                break;
            }
            case 0b0111110:{
                return alu::AluOp::kLoad_simd2;
                break;
            }
            case 0b0111100:{
        ...
        case 0b101: {// kSrl, kSra, kDivu
            ...
            case 0b0011111: {
                return alu::AluOp::kDiv_simd16;
                break;
            }
            case 0b0111111: {
                return alu::AluOp::kDiv_simd8;
                break;
            }
            case 0b1111111:{
        ...
        case 0b110: {// kOr, kRem
            ...
            case 0b0011111: {
                return alu::AluOp::kRem_simd16;
                break;
            }
            case 0b0111111: {
                return alu::AluOp::kRem_simd8;
                break;
            }
            case 0b1111111:{
    ...
    case 0b1010011: {
        switch (funct7) {
            ...
            case 0b0011001: { // fsub.bf16
                return alu::AluOp::FSUB_BF16;
            }
            case 0b0011010: { // fmul.bf16
                return alu::AluOp::FMUL_BF16;
            }
            case 0b0011011: { // fmax.bf16
                return alu::AluOp::FMAX_BF16;
            }
...
// --- NEW FLOAT16 R-Type ---
            ...
            case 0b0101001: { // kfsub_fp16
                return alu::AluOp::FSUB_FP16;
            }
            case 0b0101010: { // kfmul_fp16
                return alu::AluOp::FMUL_FP16;
            }
            case 0b0101011: { // kfmax_fp16
                return alu::AluOp::FMAX_FP16;
            }
        ...
        case 0b0111001: { // kfsub_msfp16
            return alu::AluOp::FSUB_MSFP16;
        }
        case 0b0111010: { // kfmul_msfp16
            return alu::AluOp::FMUL_MSFP16;
        }
        case 0b0111011: { // kfmax_msfp16
            return alu::AluOp::FMAX_MSFP16;
        }
        }
        break;
    }
